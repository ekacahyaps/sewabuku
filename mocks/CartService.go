...
// AddCartSrv provides a mock function with given fields: token, newCart
func (_m *CartService) AddCartSrv(token interface{}, newCart cart.Core) (cart.Core, error) {
...
// DeleteCartSrv provides a mock function with given fields: token, cartID
func (_m *CartService) DeleteCartSrv(token interface{}, cartID uint) error {
...
// MyCartSrv provides a mock function with given fields: token
func (_m *CartService) MyCartSrv(token interface{}) ([]cart.Core, error) {
	ret := _m.Called(token)
