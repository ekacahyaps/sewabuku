...
func (_m *BookHandler) AllBooks() echo.HandlerFunc {
	ret := _m.Called()
...
// BooksDetail provides a mock function with given fields:
func (_m *BookHandler) BooksDetail() echo.HandlerFunc {
	ret := _m.Called()
...
// BooksRented provides a mock function with given fields:
func (_m *BookHandler) BooksRented() echo.HandlerFunc {
	ret := _m.Called()
...
// MyBooks provides a mock function with given fields:
func (_m *BookHandler) MyBooks() echo.HandlerFunc {
	ret := _m.Called()
